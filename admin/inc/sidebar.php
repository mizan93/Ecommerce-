        ...
        <div class="block" id="section-menu">
            <ul class="section menu">
                <li><a class="menuitem">Site Option</a>
                    <ul class="submenu">
                        <li><a href="admintitlSlogan.php">Admin Title & Slogan</a></li>
                        <li><a href="companyinfo.php">Add company information</a></li>
                        <li><a href="titleslogan.php">Client Title & Slogan</a></li>
