 ...
 <body>
     <div class="container_12">
                 ...
                 <?php
                    ...
                    ?>
                     <div class="floatleft logo">
                         <img src="admin/<?php echo $data['image']; ?>" alt="Logo" />
                     </div>
         ...
         <div class="grid_12">
             <ul class="nav main">
                 <li class="ic-dashboard"><a href="dasboard.php"><span>Dashboard</span></a> </li>
                 <?php
                    $admin = Session::get('adminRole');
                    if ($admin == 0) {
                 ...
                 <li class="ic-grid-tables"><a href="inbox.php"><span>Order
                             <?php
                                $query = "SELECT * FROM order_tbl WHERE status=0 ORDER BY id DESC";
                                $msg = $db->select($query);
                                if ($msg) {
                 ...
                 <li class="ic-grid-tables"><a href="message.php"><span>Message
                             <?php
                                $query = "SELECT * FROM contact WHERE status=0 ORDER BY cmrID DESC";
                                $msg = $db->select($query);
                                if ($msg) {
                                    $count = mysqli_num_rows($msg);
                                    echo "(" . $count . ")";
