...
<?php
if (!isset($_GET['getcat_id']) && $_GET['getcat_id'] == null) {
	echo "<script>window.location = '404.php'; </script>";
	//header('Location: 404.php');
} else {
	$id = preg_replace('/[^-a-zA-Z0-9_]/', '', $_GET['getcat_id']);
}

$getdata = $product->getProductBYcatId($id);
$getcatname = $product->getcatName($id);
...
<div class="main">
	<div class="content">
		<div class="content_top">
			<div class="heading">
				<?php if ($getcatname) {
					while ($data = $getcatname->fetch_assoc()) {
				?>
		...
		<div class="section group">
			...
			<?php }
				...
				echo '<p>Product of this category is out of store !!</p><br>';
